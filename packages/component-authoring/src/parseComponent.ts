...
//   if (
//     (value.type === Openapi.Enums.ComponentPropType.String ||
//       value.type === Openapi.Enums.ComponentPropType.StringEnum) &&
...
//   if (
//     (value.type === Openapi.Enums.ComponentPropType.Number ||
//       value.type === Openapi.Enums.ComponentPropType.NumberEnum) &&
...
//   if (
//     value.type === Openapi.Enums.ComponentPropType.Boolean &&
...
//   if (
//     value.type === Openapi.Enums.ComponentPropType.Array &&
...
//   if (value.type !== Openapi.Enums.ComponentPropType.Object) {
//     return [];
//   }
...
//     return { type: Openapi.Enums.ComponentPropType.String };
//   }

//   if (typeNode.isKind(SyntaxKind.NumberKeyword)) {
//     return { type: Openapi.Enums.ComponentPropType.Number };
//   }

//   if (typeNode.isKind(SyntaxKind.BooleanKeyword)) {
//     return { type: Openapi.Enums.ComponentPropType.Boolean };
//   }
...
//     return {
//       type: Openapi.Enums.ComponentPropType.Array,
//       item: parsePropValue(
...
//     return {
//       type: Openapi.Enums.ComponentPropType.Object,
//       properties: typeNode
//         .getMembers()
...
//     return {
//       type: Openapi.Enums.ComponentPropType.StringEnum,
...
//     return {
//       type: Openapi.Enums.ComponentPropType.NumberEnum,
...
//     (value) => value.type === Openapi.Enums.ComponentPropType.Boolean,
//   ).length;
...
//   if (
//     objectValues.every(
//       (value) => value.type === Openapi.Enums.ComponentPropType.Object,
//     )
//   ) {
//     return {
//       type: Openapi.Enums.ComponentPropType.Object,
//       properties: objectValues.flatMap((value) =>
//         value.type === Openapi.Enums.ComponentPropType.Object
//           ? value.properties
//           : [],
//       ),
//     };
...
//     return { type: Openapi.Enums.ComponentPropType.StyleProperties };
//   }
...
//   if (objectValue.type !== Openapi.Enums.ComponentPropType.Object) {
//     return parseTypeFallback(typeNode);
//   }
...
//     if (resolved?.type === Openapi.Enums.ComponentPropType.StringEnum) {
...
//   return {
//     type: Openapi.Enums.ComponentPropType.Unknown,
//     rawType,
//   };
// }
...
//     return Openapi.Enums.ComponentPartKind.Element;
//   }

//   return Openapi.Enums.ComponentPartKind.Component;
// }
